      ...
      <nav className="navbar-bg relative">
        <div className="max-w-container mx-auto md:py-4 py-1 px-4 md:px-3 xl:px-0">
          <div className=" md:flex md:items-center">
            ...
            <div
              onClick={handleClick}
              className={`md:hidden absolute top-4 right-0 text-2xl px-2 `}
            >
              {show == true ? <GrClose /> : <FaBars />}
            </div>
            {/* icon */}
            <div
              className={`md:flex md:items-center xl:w-3/4 justify-end duration-500 ${
                show ? "left-0" : "left-[-100%]"
              } md:static absolute left-0 w-full pl-5 md:pl-0 bg-[#FFF8ED] z-10`}
            >
              <ul className="flex md:flex-row flex-col  md:gap-x-3 lg:gap-x-6 gap-y-2">
                <li className="text-[#817382] capitalize font-bold font-Raleway hover:text-primary duration-300 cursor-pointer">
                  home
                </li>
                <li className="text-[#817382] capitalize font-bold font-Raleway hover:text-primary duration-300 cursor-pointer">
                  Our services
              ...
              <div className="mt-3 md:mt-0 pb-5 md:pb-0">
                <a
                  href="#"
                  className=" px-2 py-2.5 md:py-[12px] md:px-[20px] border rounded-md md:ml-2 bg-[#FFE4D9] text-primary  capitalize font-Oxanium md:font-bold font-semibold md:text-[20px] hover:bg-primary hover:text-white  duration-500"
                >
                  contact us
                </a>
              </div>
