        ...
        <div className="bg-delivery-bg bg-no-repeat  bg-cover rounded-2xl">
          <div className="xl:pt-32 xl:pb-[168px] py-20 bg-[#0A090DCC] rounded-2xl p-5">
            <div className="text-center">
              <img className="mx-auto scale-75 xl:scale-100 " src={playIcon} alt="..." />
              <h2 className='font-Oxanium font-bold text-2xl sm:text-3xl text-primary xl:mt-5  md:mt-2 '>FASTEST DELIVERY</h2>
