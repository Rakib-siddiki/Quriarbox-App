          ...
          <div className="sm:col-start-3 sm:col-span-8 sm:col-end-11">
            <div className="flex">
              ...
              <div className="w-1/2 text-center sm:text-left">
                ...
                <h2 className=" font-Raleway font-extrabold xl:text-4xl lg:text-3xl md:text-2xl text-sm sm:text-xl text-[#222132] md:mt-4 md:mb-2 my-1">
                  We will contact in the shortest time.
                </h2>
                <p className="font-Raleway font-semibold text-[12px] sm:text-base md:text-2xl text-[#9291A1]">
              ...
              <div className="w-1/2 ml-2">
                <div className="flex flex-col gap-y-2 sm:gap-y-4 ">
                  ...
                  <a
                    href="#"
                    className="xl:py-3 justify-center border border-primary inline-flex items-center xl:mt-10 xl:mb-12 rounded-md hover:text-primary font-Oxanium font-bold text-center lg:text-xl bg-primary hover:bg-white text-white duration-500 p-2 text-sm mt-2"
                  >
                    Send Message
