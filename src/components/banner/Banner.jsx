    ...
    <>
      <section className="max-w-container mx-auto">
        <div className="flex py-6 px-5 md:p-0 relative">
          {/* shape  */}
          <img
            className="hidden xl:block absolute top-[496px] -right-16"
            src={couldShape}
            alt="..."
          />
          {/* shape  */}
          ...
          <div className=" w-2/5 xl:mt-44 md:py-16">
            <div className="md:ml-5 xl:m-0 md:mt-10">
              ...
              <p className="text-secondary xl:text-xl font-Raleway font-normal xl:w-80 xl:mt-4 w-62 my-2 md:my-4 text-sm">
                We deliver your products safely to your home in a reasonable
                time.
              </p>
              <a
                className="hover:border-primary  border inline-flex items-center xl:text-xl font-Oxanium font-semibold text-white bg-primary rounded-md xl:py-3 xl:px-5 xl:mt-10 p-2 hover:bg-[#FFE4D9] hover:text-primary duration-500"
                href="#"
              >
                Get started{" "}
                <span className="ml-2">
